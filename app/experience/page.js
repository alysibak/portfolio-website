      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 md:py-16 pt-24 md:pt-32 max-w-5xl">
        ...
        <motion.div
          className={`rounded-xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 mt-8 md:mt-12 ${
            darkMode 
              ? 'bg-gray-800 bg-opacity-80 border-gray-600 hover:border-cyan-500' 
              : 'bg-white bg-opacity-90 border-blue-200 hover:border-cyan-400'
          }`}
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 md:gap-6">
            <div className="flex-1">
              <h3 className={`text-xl md:text-2xl font-bold mb-2 ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                University of Guelph
              </h3>
              <p className={`text-lg md:text-xl mb-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                B.Comp (Hons), Computer Science (Co-op)
              </p>
              <p className={`text-base md:text-lg mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                GPA: 83%
              </p>
        ...
        >
          ...
          <p className={`text-base md:text-lg mb-6 md:mb-8 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            I&apos;m always open to discussing new opportunities and challenges
          </p>
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
            <Link 
              href="/projects" 
              className="bg-gradient-to-r from-blue-600 to-cyan-600 px-6 md:px-8 py-3 md:py-4 rounded-xl text-white hover:scale-105 transition-all duration-300 shadow-lg font-semibold text-sm md:text-base"
            >
              View My Projects
            </Link>
            <Link 
              href="/contact" 
              className={`border-2 px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:scale-105 transition-all duration-300 shadow-lg text-sm md:text-base ${
                darkMode 
